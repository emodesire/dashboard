<template>
    <div class="tenBox">
        <eCha :options="options" @click="jump" h="100%" />
        <el-button v-show="options.geo3D.map != '100000'" @click="changeMap('100000')" class="btn" type="success"
...
import geoJson from "./map/100000.json";
...
const options = reactive(
    {
        ...
        "backgroundColor": "#000080", // 优先于theme="dark"
        'theme' : "light",
        "tooltip": {
            "show": true,
            formatter(params) {
        ...
        "series": [
            {
                "name": "资金流入",
                "type": "bar3D",
                "minHeight": 2.2, // 坑，需要大于0，否则最低的柱状图渲染会出问题
